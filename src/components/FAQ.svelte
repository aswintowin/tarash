...
<section id="faq">
	<faq class="flex flex-row">
		...
		>
          ...
          <p class="text-green-400 font-semibold text-lg px-4" hidden={!result}>Thank you! We will get in touch with you as soon as possible.</p>
        </div>
			</form>
